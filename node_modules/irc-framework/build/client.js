...
module.exports = function (_EventEmitter) {
    ...
    function IrcClient(options) {
        ...
        var _this = _possibleConstructorReturn(this, (IrcClient.__proto__ || Object.getPrototypeOf(IrcClient)).call(this));
...
function truncateString(str, block_size) {
    ...
    while (remaining_string.length) {
        ...
        this_block_size = isHighSurrogate(remaining_string.charCodeAt(block_size - 1)) ? block_size - 1 : block_size;
