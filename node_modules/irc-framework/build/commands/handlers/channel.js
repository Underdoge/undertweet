...
var handlers = {
    RPL_CHANNELMODEIS: function RPL_CHANNELMODEIS(command) {
    ...
    RPL_CREATIONTIME: function RPL_CREATIONTIME(command) {
        var channel = command.params[1];
    ...
    RPL_CHANNEL_URL: function RPL_CHANNEL_URL(command) {
        var channel = command.params[1];
    ...
    RPL_NAMEREPLY: function RPL_NAMEREPLY(command) {
        var that = this;
    ...
    RPL_ENDOFNAMES: function RPL_ENDOFNAMES(command) {
    ...
    RPL_BANLIST: function RPL_BANLIST(command) {
    ...
    RPL_ENDOFBANLIST: function RPL_ENDOFBANLIST(command) {
        var cache = this.cache('banlist.' + command.params[1]);
        this.emit('banlist', {
            channel: command.params[1],
            bans: cache.bans || []
    ...
    RPL_TOPIC: function RPL_TOPIC(command) {
        this.emit('topic', {
            channel: command.params[1],
    ...
    RPL_NOTOPIC: function RPL_NOTOPIC(command) {
        this.emit('topic', {
            channel: command.params[1],
            topic: ''
        });
    ...
    RPL_TOPICWHOTIME: function RPL_TOPICWHOTIME(command) {
    ...
    INVITE: function INVITE(command) {
        var time = command.getServerTime();
    ...
    RPL_INVITING: function RPL_INVITING(command) {
        this.emit('invited', {
